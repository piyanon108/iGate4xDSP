...
public:
    ...
    int getsnmp_int_new(std::string ip, const char* oidname, int id, QString oidStringName, QString address);
    ...
    QString getsnmp_string_new(std::string ip, const char* oidname, int id, QString oidStringName, QString address);
